...
return [
    ...
    'plans' => [
        ...
        'solo_growth' => [
            ...
            'features' => [
                'Tout Solo Growth',
                'Capacite premium pour scaler seul',
                'Plus de credits IA et scans de plan',
                'Pilotage avance et support prioritaire',
            ],
        ],
        'starter' => [
            'name' => 'Team Core',
