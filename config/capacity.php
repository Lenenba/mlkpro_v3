    ...
    'scenarios' => [
        ...
        'reservation_creation' => [
            ...
            'protocol' => [
                ...
                'unique_by' => [
                    ['body.team_member_id', 'body.starts_at'],
                ],
                'preparation' => [],
            ...
            'profile' => [
                ...
                'duration' => '10m',
                'ramp_up' => '2m',
                'request_interval_ms' => (int) env('CAPACITY_RESERVATION_STORE_REQUEST_INTERVAL_MS', 45000),
                'minimum_request_interval_ms' => 45000,
        ...
        'sales_creation' => [
            ...
            'profile' => [
                ...
                'duration' => '10m',
                'ramp_up' => '2m',
                'request_interval_ms' => (int) env('CAPACITY_SALES_STORE_REQUEST_INTERVAL_MS', 45000),
                'minimum_request_interval_ms' => 45000,
        ...
        'public_request_submission' => [
            ...
            'profile' => [
                ...
                'duration' => '10m',
                'ramp_up' => '2m',
                'request_interval_ms' => (int) env('CAPACITY_PUBLIC_REQUEST_REQUEST_INTERVAL_MS', 45000),
                'minimum_request_interval_ms' => 45000,
        ...
        'public_store_checkout' => [
            ...
            'profile' => [
                ...
                'duration' => '10m',
                'ramp_up' => '2m',
                'request_interval_ms' => (int) env('CAPACITY_PUBLIC_STORE_CHECKOUT_REQUEST_INTERVAL_MS', 45000),
                'minimum_request_interval_ms' => 45000,
