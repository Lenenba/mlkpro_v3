...
const taskMetrics = computed(() => ([
    {
        key: 'tasks-total',
        label: t('dashboard_tasks.kpi.total'),
        value: stat('tasks_total'),
        tone: 'emerald',
        colorClass: 'bg-emerald-500/70 dark:bg-emerald-400/50',
        trend: kpiData.value.tasks_total.trend,
        points: kpiData.value.tasks_total.points,
    },
    {
        key: 'tasks-todo',
        ...
        <div class="space-y-6">
            <div class="rounded-sm border border-stone-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
                ...
                <p class="mt-1 text-sm text-stone-600 dark:text-neutral-400">
                    {{ $t('dashboard_tasks.subtitle_admin', { name: userName }) }}
                </p>
            </div>
                        ...
                        <div v-for="task in tasks" :key="task.id"
                            ...
                            <div class="min-w-0">
                                ...
                                <div class="text-xs text-stone-500 dark:text-neutral-400">
                                    ...
                                    {{ $t('dashboard.labels.assignee', { name: task.assignee?.name || '-' }) }}
                                </div>
                            </div>
