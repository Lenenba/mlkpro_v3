            ...
            <section
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div class="space-y-6">
                            <div class="space-y-2">
                                <h2 class="text-sm font-semibold text-stone-800 dark:text-neutral-100">{{ $t('privacy.sections.scope.title') }}</h2>
                                <p class="text-sm text-stone-600 dark:text-neutral-300">
                                    {{ $t('privacy.sections.scope.body') }}
                                </p>
                            </div>

                            <div class="space-y-2">
                                <h2 class="text-sm font-semibold text-stone-800 dark:text-neutral-100">{{ $t('privacy.sections.data.title') }}</h2>
                                <p class="text-sm text-stone-600 dark:text-neutral-300">
                                    {{ $t('privacy.sections.data.body') }}
                                </p>
                            </div>

                            <div class="space-y-2">
                                <h2 class="text-sm font-semibold text-stone-800 dark:text-neutral-100">{{ $t('privacy.sections.usage.title') }}</h2>
                                <p class="text-sm text-stone-600 dark:text-neutral-300">
                            ...
                            <div class="space-y-2">
                                <h2 class="text-sm font-semibold text-stone-800 dark:text-neutral-100">{{ $t('privacy.sections.sharing.title') }}</h2>
                                <p class="text-sm text-stone-600 dark:text-neutral-300">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-2">
                                <h2 class="text-sm font-semibold text-stone-800 dark:text-neutral-100">{{ $t('privacy.sections.security.title') }}</h2>
                                <p class="text-sm text-stone-600 dark:text-neutral-300">
                            ...
                            <div class="space-y-2">
                                <h2 class="text-sm font-semibold text-stone-800 dark:text-neutral-100">{{ $t('privacy.sections.retention.title') }}</h2>
                                <p class="text-sm text-stone-600 dark:text-neutral-300">
                            ...
                            <div class="space-y-2">
                                <h2 class="text-sm font-semibold text-stone-800 dark:text-neutral-100">{{ $t('privacy.sections.rights.title') }}</h2>
                                <p class="text-sm text-stone-600 dark:text-neutral-300">
                            ...
                            <div class="space-y-2">
                                <h2 class="text-sm font-semibold text-stone-800 dark:text-neutral-100">{{ $t('privacy.sections.contact.title') }}</h2>
                                <p class="text-sm text-stone-600 dark:text-neutral-300">
