            ...
            <div class="rounded-sm border border-stone-200 bg-white p-4 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
                <form class="space-y-4" @submit.prevent="submit">
                    ...
                    <div class="grid gap-3 md:grid-cols-2">
                        <div>
                            <FloatingInput v-model="form.quiet_hours_start" label="Quiet hours start (HH:MM)" />
                            <InputError class="mt-1" :message="form.errors.quiet_hours_start" />
                        </div>
                        <div>
                            <FloatingInput v-model="form.quiet_hours_end" label="Quiet hours end (HH:MM)" />
                    ...
                    <div>
                        ...
                        <div class="mt-2 grid gap-3 md:grid-cols-3">
                            ...
                            <div>
                                <FloatingInput v-model="form.rules.payment_failed" label="Payment failed" type="number" />
                                <InputError class="mt-1" :message="form.errors['rules.payment_failed']" />
                            </div>
                            <div>
                                <FloatingInput v-model="form.rules.churn_risk" label="Churn risk" type="number" />
