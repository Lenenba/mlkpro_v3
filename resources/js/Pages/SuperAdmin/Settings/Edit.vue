...
const moduleKeys = computed(() => [
    ...
    { key: 'sales', label: t('super_admin.settings.modules.sales') },
    { key: 'sales_crm', label: t('super_admin.settings.modules.sales_crm') },
    { key: 'promotions', label: t('super_admin.settings.modules.promotions') },
