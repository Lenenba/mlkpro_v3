...
const tonePalette = {
    ...
    campaigns: { accent: '#d946ef', glow: 'rgba(217,70,239,0.35)', text: 'text-fuchsia-600 dark:text-fuchsia-400' },
    loyalty: { accent: '#f59e0b', glow: 'rgba(245,158,11,0.35)', text: 'text-amber-600 dark:text-amber-400' },
    performance: { accent: '#14b8a6', glow: 'rgba(20,184,166,0.35)', text: 'text-teal-600 dark:text-teal-400' },
    presence: { accent: '#0ea5e9', glow: 'rgba(14,165,233,0.35)', text: 'text-sky-600 dark:text-sky-400' },
    planning: { accent: '#8b5cf6', glow: 'rgba(139,92,246,0.35)', text: 'text-violet-600 dark:text-violet-400' },
