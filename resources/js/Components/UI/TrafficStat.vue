                            ...
                            <div class="py-1 px-2">
                                <div class="flex items-center bg-gray-100 rounded-xl p-1 dark:bg-neutral-800">
                                    <label for="hs-pro-dbrrtchddts1"
                                        ...
                                        <input type="radio" name="hs-pro-dbrrtchddts" class="hidden"
            ...
            <div class="h-full flex flex-col justify-between space-y-4">
                <div class="space-y-4">
                    ...
                    <div class="flex gap-x-1 w-full h-2.5 rounded-full overflow-hidden">
                        <div class="flex flex-col justify-center overflow-hidden bg-blue-500 text-xs text-white text-center whitespace-nowrap"
                            style="width: 42%" role="progressbar" aria-valuenow="42" aria-valuemin="0"
                            aria-valuemax="100"></div>
                        <div class="flex flex-col justify-center overflow-hidden bg-violet-500 text-xs text-white text-center whitespace-nowrap"
                            style="width: 27%" role="progressbar" aria-valuenow="27" aria-valuemin="0"
                            aria-valuemax="100"></div>
                        <div class="flex flex-col justify-center overflow-hidden bg-teal-400 text-xs text-white text-center whitespace-nowrap"
                            style="width: 16%" role="progressbar" aria-valuenow="16" aria-valuemin="0"
                            aria-valuemax="100"></div>
