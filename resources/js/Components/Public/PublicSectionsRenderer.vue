...
const themeStyle = computed(() => {
    ...
    if (palette.background_color) style['--page-background'] = palette.background_color;
    if (palette.background_alt_color) style['--page-background-alt'] = palette.background_alt_color;
    if (palette.surface_color) style['--page-surface'] = palette.surface_color;
    if (palette.text_color) style['--page-text'] = palette.text_color;
    if (palette.muted_color) style['--page-muted'] = palette.muted_color;
    ...
    if (palette.background_color) {
        ...
        style['--page-bg'] = palette.background_style === 'solid'
            ? bg
...
<template>
    <div class="public-sections" :style="themeStyle">
                                    ...
                                    <div class="public-showcase-frame" :class="{ 'public-showcase-frame--empty': !section.image_url }">
                                        ...
                                        <div class="public-showcase-screen">
                                            <img
                                                ...
                                                :src="section.image_url"
                                                :alt="section.image_alt || section.title"
                                                class="public-showcase-screen__image"
                                                loading="lazy"
                                                decoding="async"
                                            />
                                        </div>
...
.public-feature-pairs__media {
    ...
    background:
        ...
        linear-gradient(180deg, rgba(240, 246, 249, 0.98) 0%, rgba(224, 235, 241, 0.94) 100%);
...
.public-feature-pairs__image {
    ...
    height: auto;
    max-width: 100%;
    max-height: clamp(16rem, 34vw, 24rem);
    margin-inline: auto;
    border-radius: calc(var(--page-radius, 4px) + 6px);
    background: #ffffff;
    box-shadow: 0 22px 46px -34px rgba(15, 23, 42, 0.34);
}
...
.public-industry-grid__card {
    ...
    background:
        radial-gradient(circle at top left, rgba(255, 255, 255, 0.85), rgba(255, 255, 255, 0) 35%),
...
.public-industry-grid__card:focus-visible {
    ...
    border-color: rgba(8, 58, 92, 0.16);
}
...
.public-showcase-screen {
    ...
    background:
        linear-gradient(180deg, rgba(248, 250, 252, 0.14), rgba(248, 250, 252, 0.04)),
        rgba(15, 23, 42, 0.18);
}

.public-showcase-screen__image {
    display: block;
    width: 100%;
    height: 100%;
    object-fit: contain;
...
.public-showcase-floating {
    ...
    background:
        linear-gradient(180deg, rgba(255, 255, 255, 0.98), rgba(237, 244, 247, 0.96));
