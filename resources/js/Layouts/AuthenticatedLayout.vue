...
<template>
    ...
    <main id="content" class="lg:ps-[260px] pt-[59px] ">
        <div class="p-2 sm:p-5 sm:py-0 md:pt-5 space-y-5">
            <div v-if="flashSuccess" class="bg-teal-50 border-t-2 border-teal-500 rounded-lg p-4 dark:bg-teal-800/30"
    ...
    <footer class="lg:ps-[260px] h-[40px] sm:h-[64px] absolute bottom-0 inset-x-0">
        <div class="p-2 sm:p-5 flex justify-between items-center">
            ...
            <ul>
                ...
                <li
                    class="inline-block relative pe-5 text-xs sm:text-sm text-gray-500 align-middle sm:leading-3 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-2 before:-translate-y-1/2 before:w-px before:h-3.5 before:bg-gray-400 before:rotate-[18deg] dark:text-neutral-500 dark:before:bg-neutral-600">
                    <button type="button"
                        class="hover:text-blue-600 focus:outline-none focus:text-gray-800 dark:hover:text-neutral-200 dark:focus:text-neutral-400"
                        data-hs-overlay="#hs-pro-dfkm">
                        <svg class="shrink-0 size-3.5 sm:size-4" xmlns="http://www.w3.org/2000/svg" width="24"
    ...
    <!-- Search Modal -->
    <div id="hs-pro-dnsm"
        class="hs-overlay hs-overlay-backdrop-open:backdrop-blur-md hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none"
        role="dialog" tabindex="-1" aria-label="Search">
        <div
            class="hs-overlay-open:opacity-100 hs-overlay-open:duration-500 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
            <div
                class="max-h-full relative w-full flex flex-col bg-white rounded-xl pointer-events-auto shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)] dark:bg-neutral-800">
                <!-- Input -->
                <div class="relative">
                ...
                <!-- Body -->
                <div
                    class="h-[500px] p-4 overflow-y-auto overflow-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                    <!-- List Group -->
                    <div
                        class="pb-4 mb-4 last:pb-0 last:mb-0 last:border-0 border-b border-gray-200 dark:border-neutral-700">
                        ...
                        <div class="flex flex-wrap  gap-1 sm:gap-2">
                            <a class="inline-flex items-center gap-x-1.5 text-xs text-gray-800 bg-white border border-gray-200 hover:bg-gray-100 py-1.5 px-2.5 rounded-full focus:outline-none focus:bg-gray-100 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                href="#">
                    ...
                    <div
                        ...
                        <ul class="-mx-2.5 ">
                            <!-- List Item -->
                            <li>
                                <a class="py-2 px-3 flex items-center gap-x-3 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                    href="#">
                                    <svg class="shrink-0 size-5" width="33" height="32" viewBox="0 0 33 32" fill="none"
                                    ...
                                    <div class="ms-auto inline-flex items-center gap-x-1">
                                        <div
                                            class="size-5 flex flex-col justify-center items-center bg-white border border-gray-200 text-xs uppercase text-gray-400 rounded dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                                            <svg class="shrink-0 size-2.5 text-gray-500 dark:text-neutral-500"
                    ...
                    <div
                        ...
                        <ul class="-mx-2.5 ">
                            <!-- List Item -->
                            <li>
                                <a class="py-2 px-3 flex gap-x-3 hover:bg-gray-100 rounded-md focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                    href="#">
                                    <div class="mt-0.5">
                                                ...
                                                <div class="flex justify-end items-center gap-x-3">
                                                    <div class="flex items-center gap-x-1">
                                                        ...
                                                        <div class="flex items-center -space-x-1">
                                                            <!-- Avatar -->
                                                            <div
                                                                class="flex bg-gray-100 size-4 rounded-md ring-2 ring-white dark:bg-neutral-700 dark:ring-neutral-800">
                                                                <img class="shrink-0 size-full rounded-md"
                                                            ...
                                                            <div
                                                                class="flex bg-gray-100 size-4 rounded-md ring-2 ring-white dark:bg-neutral-700 dark:ring-neutral-800">
                                                                <span
                                                                    class="flex shrink-0 justify-center items-center size-4 bg-violet-200 text-violet-800 text-xs uppercase rounded-md dark:bg-violet-800 dark:text-white">L</span>
                                                            </div>
                                                            <!-- End Avatar -->
                                                        </div>
                                                        <!-- End Avatar Group -->
                                                    ...
                                                    <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <path fill="#00832D"
                                                            d="M108 96l17.06 19.5L148 130.16l4-34.03-4-33.28-23.38 12.88z">
                                                        </path>
                                                        <path fill="#0066DA"
                                                            d="M9 127v29c0 6.63 5.37 12 12 12h29l6-21.92L50 127l-19.9-6L9 127z">
                                                        </path>
                                                        <path fill="#E94235" d="M50 24L9 65l21.1 6L50 65l5.9-18.83z">
                                                        </path>
                                                        <path fill="#2684FC" d="M9 65h41v62H9z"></path>
                                                        <path fill="#00AC47"
                                                            d="M174.19 41.36L148 62.85v67.31l26.3 21.57c3.94 3.08 9.7.27 9.7-4.73V46c0-5.07-5.89-7.85-9.81-4.64zM108 96v31H50v41h86c6.63 0 12-5.37 12-12v-25.84L108 96z">
                                                        </path>
                                                        <path fill="#FFBA00"
                                                            d="M136 24H50v41h58v31l40-33.15V36c0-6.63-5.37-12-12-12z">
                                                        </path>
                                                    </svg>
                                                </div>
                                            </div>
                ...
                <!-- Footer -->
                <div
                    class="py-3 px-4 flex flex-wrap justify-between items-center gap-2 border-t border-gray-200 dark:border-neutral-700">
                    <div class="inline-flex items-center gap-x-2">
                        <div
                            class="size-5 flex flex-col justify-center items-center bg-white border border-gray-200 text-xs uppercase text-gray-400 shadow-sm rounded dark:bg-neutral-800 dark:border-neutral-700">
                            <svg class="shrink-0 size-3 text-gray-400 dark:text-neutral-500"
                    ...
                    <div class="inline-flex items-center gap-x-4">
                        <div class="inline-flex items-center gap-x-2">
                            <div
                                class="size-5 flex flex-col justify-center items-center bg-white border border-gray-200 text-xs uppercase text-gray-400 shadow-sm rounded dark:bg-neutral-800 dark:border-neutral-700">
                                <svg class="shrink-0 size-3.5 text-gray-400 dark:text-neutral-500"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
    ...
    <!-- Activity Offcanvas -->
    <div id="hs-pro-dnam"
        class="hs-overlay hs-overlay-open:translate-x-0 hidden translate-x-full fixed top-0 end-0 transition-all duration-300 transform size-full sm:w-[400px] z-[80] flex flex-col bg-white border-s hidden dark:bg-neutral-800 dark:border-neutral-700"
        role="dialog" tabindex="-1" aria-labelledby="hs-pro-dnam-label">
        <!-- Header -->
        <div class="py-2.5 px-4 flex justify-between items-center border-b dark:border-neutral-700">
            ...
            <button type="button"
                ...
                aria-label="Close" data-hs-overlay="#hs-pro-dnam">
                <span class="sr-only">Close</span>
                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
        ...
        <!-- Body -->
        <div
            class="px-5 py-7 h-full overflow-y-auto overflow-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
            <!-- Vertical Steps -->
            <div>
                <!-- Step Item -->
                <div
                    class="relative last:pb-0 pb-8 last:after:hidden after:absolute after:top-[38px] after:bottom-0 after:start-[19px] after:w-px after:bg-gray-200 dark:after:bg-neutral-700">
                    <div class="w-full flex gap-x-5">
                        ...
                        <div class="grow">
                            ...
                            <p class="text-sm text-gray-500 dark:text-neutral-500">
                                ...
                                <a class="ms-1 align-middle inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                                    href="#">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <!-- User List -->
                                    <div
                                        class="bg-white border border-gray-200 rounded-lg p-2 dark:bg-neutral-800 dark:border-neutral-700">
                                        <div class="flex gap-x-2">
                                            <svg class="shrink-0 size-6" width="32" height="32" viewBox="0 0 32 32"
                                    ...
                                    <div
                                        class="bg-white border border-gray-200 rounded-lg p-2 dark:bg-neutral-800 dark:border-neutral-700">
                                        <div class="flex gap-x-2">
                                            <svg class="shrink-0 size-6" width="33" height="32" viewBox="0 0 33 32"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                ...
                <div
                    ...
                    <div class="w-full flex gap-x-5">
                        <span
                            class="flex shrink-0 justify-center items-center size-[38px] border border-gray-200 text-sm font-semibold uppercase text-gray-800 rounded-full dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400">
                            B
                        </span>
                        ...
                        <div class="grow">
                            ...
                            <p class="text-sm text-gray-500 dark:text-neutral-500">
                                Marked
                                <a class="align-middle inline-flex items-center gap-x-1 text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-400 focus:outline-none focus:underline dark:hover:text-blue-500 dark:focus:outline-none"
                                    href="#">
                                    <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                        height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                as
                                <span
                                    class="ms-0.5 inline-block align-middle py-1 px-1.5 border border-gray-200 text-xs font-medium text-gray-800 rounded-md dark:border-neutral-700 dark:text-neutral-300">
                                    Completed
                                </span>
                            </p>
                        ...
                        <div class="grow">
                            ...
                            <div class="mt-2 flex gap-x-2">
                                <div class="grow grid grid-cols-3 gap-x-2">
                                    <img class="w-full h-12 object-cover rounded-md"
                                        src="https://images.unsplash.com/photo-1635776062360-af423602aff3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=180&q=80"
                                        alt="Media Image">
                                    <img class="w-full h-12 object-cover rounded-md"
                                        src="https://images.unsplash.com/photo-1635776063328-153b13e3c245?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=180&q=80"
                                        alt="Media Image">
                                    <img class="w-full h-12 object-cover rounded-md"
                                        src="https://images.unsplash.com/photo-1635776064096-4e12cce9ead4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=180&q=80"
                                        alt="Media Image">
                                </div>

                                <!-- Card -->
                                <div>
                                    <a class="h-full inline-flex flex-col justify-center items-center border border-gray-200 text-xs font-medium text-gray-500 rounded-lg p-1.5 hover:text-blue-600 focus:outline-none focus:bg-gray-100 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300 dark:focus:bg-neutral-700"
                                        href="#">
                                        +2
                                    </a>
                                </div>
                    ...
                    <div class="w-full flex gap-x-5">
                        ...
                        <div class="grow">
                            ...
                            <p class="text-sm text-gray-500 dark:text-neutral-500">
                                ...
                                as
                                <span
                                    class="ms-0.5 inline-block align-middle py-1 px-1.5 bg-gray-100 text-xs font-medium text-gray-800 rounded-md dark:bg-neutral-700 dark:text-neutral-300">
                                    In progress
                                </span>
                            </p>
                    ...
                    <div
                        ...
                        <div class="w-full flex gap-x-5">
                            ...
                            <div class="grow">
                                ...
                                <p class="text-sm text-gray-500 dark:text-neutral-500">
                                    Marked
                                    <a class="align-middle inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                                        href="#">
                                        <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                                            height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div
                    class="relative last:pb-0 pb-8 last:after:hidden after:absolute after:top-[38px] after:bottom-0 after:start-[19px] after:w-px after:bg-gray-200 dark:after:bg-neutral-700">
                    <button type="button"
                        class="hs-collapse-toggle hs-collapse-open:hidden group w-full text-start flex items-center gap-x-5 focus:outline-none"
                        id="hs-pro-dnao" aria-expanded="false" aria-controls="hs-pro-dnao-button"
                        data-hs-collapse="#hs-pro-dnao-button">
                        <span class="w-[38px] ">
                            <span
                                class="flex shrink-0 justify-center items-center w-6 h-7 border border-gray-200 text-sm font-semibold text-gray-800 rounded-md mx-auto dark:border-neutral-700 dark:text-neutral-400">
                                <svg class="shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <span class="grow">
                            <span
                                class="text-sm font-semibold text-gray-800 group-focus:text-blue-600 dark:text-neutral-300 dark:group-focus:text-blue-500">
    ...
    <div id="hs-pro-dasadam"
        ...
        role="dialog" tabindex="-1" aria-labelledby="hs-pro-dasadam-label">
        <div
            ...
            <div
                class="w-full max-h-full overflow-hidden flex flex-col bg-white rounded-xl pointer-events-auto shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)] dark:bg-neutral-800">
                <!-- Header -->
                <div class="py-2.5 px-4 flex justify-between items-center border-b dark:border-neutral-700">
                    ...
                    <button type="button"
                        class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-200 dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600"
                        aria-label="Close" data-hs-overlay="#hs-pro-dasadam">
                        <span class="sr-only">Close</span>
                        <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                ...
                <div id="hs-pro-datab"
                    ...
                    <div class="p-4 space-y-5">
                        <div class="space-y-2">
                            <label for="hs-pro-dasadamtn"
                                class="block mb-2 text-sm font-medium text-gray-800 dark:text-neutral-200">
                                Team name
                            </label>

                            <input id="hs-pro-dasadamtn" type="text"
                                class="py-2 px-3 block w-full border-gray-200 rounded-lg text-sm text-gray-800 focus:z-10 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:placeholder:text-neutral-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-neutral-600"
                                placeholder="Preline">
                        </div>
                      ...
                      "dropdownClasses": "mt-2 z-50 w-full min-w-36 max-h-72 p-1 space-y-0.5 overflow-hidden overflow-y-auto bg-white rounded-xl shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] dark:bg-neutral-900",
                      "optionClasses": "hs-selected:bg-gray-100 dark:hs-selected:bg-neutral-800 py-2 px-4 w-full text-sm text-gray-800 cursor-pointer hover:bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-200",
                      ...
                      "viewport": "#hs-pro-datab"
                                ...
                                <div class="absolute top-1/2 end-2.5 -translate-y-1/2">
                                    <svg class="shrink-0 w-[17px] h-[17px] text-neutral-500" width="16" height="16"
