...
return [
    ...
    'invoice' => [
        'messages' => [
            ...
            'card_requires_checkout' => 'Card payments must be completed using secure checkout.',
            'payment_pending_confirmation' => 'Payment declared. Confirmation by the company is required before the invoice is marked as paid.',
            'idempotency_conflict' => 'This payment request was already used with different details. Refresh the page to start a new payment.',
