...
return [
    ...
    'invoice' => [
        'messages' => [
            ...
            'card_requires_checkout' => 'Los pagos con tarjeta deben realizarse mediante el pago seguro.',
            'payment_pending_confirmation' => 'Pago declarado. La empresa debe confirmarlo antes de marcar la factura como pagada.',
            'idempotency_conflict' => 'Esta solicitud de pago ya se utilizó con datos diferentes. Actualice la página para iniciar un nuevo pago.',
