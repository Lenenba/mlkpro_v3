...
return [
    ...
    'invoice' => [
        'messages' => [
            ...
            'card_requires_checkout' => 'Les paiements par carte doivent être effectués via le paiement sécurisé.',
            'payment_pending_confirmation' => 'Paiement déclaré. La confirmation de l’entreprise est nécessaire avant de marquer la facture comme payée.',
            'idempotency_conflict' => 'Cette demande de paiement a déjà été utilisée avec des informations différentes. Actualisez la page pour commencer un nouveau paiement.',
