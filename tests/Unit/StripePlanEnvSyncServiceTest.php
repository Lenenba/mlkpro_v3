...
it('matches sibling currencies from the configured stripe product even when configured solo amounts differ', function () {
    ...
    $service = new class([fakeStripePrice(['id' => 'price_solo_essential_cad', 'currency' => 'cad', 'unit_amount' => 3000, 'product' => 'prod_solo_essential']), fakeStripePrice(['id' => 'price_solo_essential_eur', 'currency' => 'eur', 'unit_amount' => 1900, 'product' => 'prod_solo_essential']), fakeStripePrice(['id' => 'price_solo_essential_usd', 'currency' => 'usd', 'unit_amount' => 2200, 'product' => 'prod_solo_essential'])], ['prod_solo_essential' => fakeStripeProduct(['id' => 'prod_solo_essential', 'name' => 'SOLO ESSENTIAL', 'metadata' => []])]) extends StripePlanEnvSyncService
    {
        public function __construct(
            private array $prices,
            private array $products,
