...
it('syncs the redesigned core and growth entitlements from billing config', function () {
    ...
    expect($modules['solo_essential']['jobs'] ?? null)->toBeTrue()
        ...
        ->and($modules['starter']['social'] ?? null)->toBeFalse()
        ...
        ->and($modules['solo_growth']['accounting'] ?? null)->toBeFalse()
        ->and($modules['solo_growth']['assistant'] ?? null)->toBeTrue()
        ->and($modules['solo_growth']['social'] ?? null)->toBeTrue()
        ->and($modules['solo_growth']['reservations'] ?? null)->toBeTrue()
        ->and($modules['starter']['expenses'] ?? null)->toBeTrue()
        ->and($modules['starter']['accounting'] ?? null)->toBeFalse()
        ->and($modules['growth']['social'] ?? null)->toBeTrue()
