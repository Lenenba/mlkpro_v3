...
export default {
    ...
    safelist: [
        'bg-amber-600', 'bg-blue-600', 'bg-cyan-600', 'bg-emerald-600',
        'bg-fuchsia-600', 'bg-green-600', 'bg-indigo-600', 'bg-lime-600',
        'bg-orange-600', 'bg-red-600', 'bg-rose-600', 'bg-sky-600',
        'bg-slate-600', 'bg-stone-600', 'bg-teal-600', 'bg-violet-600',
    ],
