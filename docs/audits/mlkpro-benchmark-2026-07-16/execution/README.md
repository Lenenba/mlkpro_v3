...
- Statut global : **Phase 0 en cours — P0-001 à P0-003 terminés ; P0-004 validé localement sans avis npm, replay CI sous Node 20 encore ouvert**
- Phase active autorisée : **Phase 0, tickets P0-004 à P0-006**
...
|---|---|---|---|---|
| 0 | [Sécurité et baseline](PHASE_0_SECURITY_AND_BASELINE.md) | En cours — P0-001 à P0-003 terminés, P0-004 en validation | Aucune | Secrets remplacés, audits traités, queues alignées, baseline exploitable |
