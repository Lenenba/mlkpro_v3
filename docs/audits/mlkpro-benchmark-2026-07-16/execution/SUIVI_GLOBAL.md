...
- Progression des tickets canoniques : **P0-001 à P0-004, P0-007, P1-001 et P1-002 sont terminés ; P0-005/P0-006 restent des preuves opérationnelles reportées sous dérogation ; P1-003 est en cours**. Cet indicateur ne mesure ni la charge ni un pourcentage d’achèvement produit.
- Prochaine gate de sortie de phase : **validation technique locale de P1-003 — chargement des traductions par domaine, fallback anglais, mesures et rollback**.
...
| 1 — Gains rapides de performance | Supprimer les coûts frontend globaux sans changer les workflows | P1-001 et P1-002 terminés après acceptation humaine ; P1-003 est autorisé | Ouverte — P1-003 en cours | Exécuter et valider P1-003, sans attribuer de gain à une baseline dynamique absente | Gains mesurés, contrats frontend inchangés, Playwright vert et budgets frontend actifs en CI |
...
| 3 | P1-003 — Traductions par domaine | Charger les catalogues nécessaires sans changer les clés ni le fallback anglais | En cours | GO autorisé après P1-002 ; mesurer le JavaScript initial et vérifier FR/EN/ES, sans staging ni production |
...
| 6 | Exécuter P1-003 | En cours — GO autorisé | Chargement i18n par domaine validé localement, fallback anglais et rollback vérifiés |
