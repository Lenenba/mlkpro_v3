...
- Progression des tickets canoniques : **P0-001 à P0-004, P0-007, P1-001 et P1-002 sont terminés ; P0-005/P0-006 restent des preuves opérationnelles reportées sous dérogation ; P1-003 à P1-005 sont en validation locale**. Cet indicateur ne mesure ni la charge ni un pourcentage d’achèvement produit.
- Prochaine gate de sortie de phase : **obtenir une CI distante verte pour P1-005, puis les acceptations humaines de P1-003 à P1-005, sans attribuer de gain à une baseline dynamique absente**.
...
| 5 | P1-005 — Budgets frontend CI | Versionner les tailles gzip et budgets par entrée/parcours | En validation locale | Commit `2ff77eea` ; sept parcours JS/CSS/i18n, quatre profils AVIF/WebP locaux, baseline et plafond +5 %, test Node 3/3, build Vite et garde réel verts | Confirmer la CI distante et obtenir l’acceptation humaine ; une hausse/suppression/changement de profil exige une décision dédiée P1-005, acceptée et non expirée |
...
| 6 | Confirmer P1-005 — Budgets frontend CI | En validation locale | Build, sept parcours, i18n et médias stock contrôlés ; la CI distante doit confirmer le garde ; exception uniquement via décision P1-005 acceptée et active |
