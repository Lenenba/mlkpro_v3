...
Révision : 49 — manifeste multi-scopes v2 validé sur les matrices locales
...
Branche distante : `origin/feature/pulse-buffer-refonte`, baseline CI validée `b11a9f35` via quality #408
