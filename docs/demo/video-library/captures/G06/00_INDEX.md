# Index - docs/demo/video-library/captures/G06
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [README.md](README.md) | Galerie des captures — G06 Créer une promotion | Brouillon | Classement manuel | Galerie explicite de G06; tous les PNG restent a produire et valider. |
...
| Créé le | Modifié le | Document | Titre | État du document | Source | Note |
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [capture-session.md](capture-session.md) | G06 — Runbook de la session de captures | Complet | Classement manuel | Runbook reproductible pour transformer les 15 cibles G06 en PNG valides. |
