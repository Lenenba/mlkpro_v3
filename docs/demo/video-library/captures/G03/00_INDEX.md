# Index - docs/demo/video-library/captures/G03
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [README.md](README.md) | Galerie des captures — G03 Créer un client | Brouillon | Classement manuel | Galerie explicite de G03; tous les PNG restent a produire et valider. |
...
| Créé le | Modifié le | Document | Titre | État du document | Source | Note |
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [capture-session.md](capture-session.md) | G03 — Runbook de la session de captures | Complet | Classement manuel | Runbook reproductible pour transformer les 16 cibles G03 en PNG valides. |
