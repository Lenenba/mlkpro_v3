# Index - docs/demo/video-library/captures/G02
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [README.md](README.md) | Galerie des captures — G02 Se repérer | Brouillon | Classement manuel | Galerie explicite de G02; tous les PNG restent a produire et valider. |
...
| Créé le | Modifié le | Document | Titre | État du document | Source | Note |
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [capture-session.md](capture-session.md) | G02 — Runbook de la session de captures | Complet | Classement manuel | Runbook reproductible pour transformer les 12 cibles G02 en PNG valides. |
