# Index - docs/demo/video-library/captures/G08
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [README.md](README.md) | Galerie des captures — G08 Facturer et encaisser | Brouillon | Classement manuel | Galerie explicite de G08; tous les PNG restent a produire et valider. |
...
| Créé le | Modifié le | Document | Titre | État du document | Source | Note |
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [capture-session.md](capture-session.md) | G08 — Runbook de la session de captures | Complet | Classement manuel | Runbook reproductible pour transformer les 18 cibles G08 en PNG valides. |
