# Index - docs/demo/video-library/captures/G01
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [README.md](README.md) | Galerie des captures — G01 Onboarding | Brouillon | Classement manuel | Galerie explicite de G01; tous les PNG restent a produire et valider. |
...
| Créé le | Modifié le | Document | Titre | État du document | Source | Note |
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [capture-session.md](capture-session.md) | G01 — Runbook de la session de captures | Complet | Classement manuel | Runbook reproductible pour transformer les 21 cibles G01 en PNG valides. |
