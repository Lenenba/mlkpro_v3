# Index - docs/demo/video-library/captures/G07
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| [annotated](annotated/00_INDEX.md) | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |
| [desktop](desktop/00_INDEX.md) | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 |

## En cours

| Créé le | Modifié le | Document | Titre | État du document | Source | Note |
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [README.md](README.md) | Galerie des captures — G07 Ajouter un membre à l'équipe | Brouillon | Classement manuel | Galerie explicite de G07; tous les PNG restent a produire et valider. |
...
| Créé le | Modifié le | Document | Titre | État du document | Source | Note |
| --- | --- | --- | --- | --- | --- | --- |
| 2026-08-11 | 2026-08-11 | [capture-session.md](capture-session.md) | G07 — Runbook de la session de captures | Complet | Classement manuel | Runbook reproductible pour transformer les 15 cibles G07 en PNG valides. |
