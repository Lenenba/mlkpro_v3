...
- [ ] Préparer le worker avec `herd php -d memory_limit=512M artisan queue:workloads development --memory=512` lorsque le provisioning, les invitations ou les notifications doivent être montrés.
