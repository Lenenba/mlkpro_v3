...
class TeamMemberController extends Controller
{
    private const AVAILABLE_PERMISSIONS = [
        ...
        ['id' => 'accounting.view', 'name' => 'View accounting workspace'],
        ['id' => 'accounting.manage', 'name' => 'Manage accounting periods and finance controls'],
    ...
    private const PERMISSION_FEATURE_MAP = [
        ...
        'social.view' => 'social',
        'social.manage' => 'social',
        'social.publish' => 'social',
        'social.approve' => 'social',
