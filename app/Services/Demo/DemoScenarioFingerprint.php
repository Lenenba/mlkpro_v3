        ...
        $payload = [
            ...
            'social_accounts' => DB::table('social_account_connections')
                ...
                ->get([
                    ...
                    DB::raw("case when logical_destination_key is null then 'missing' else 'assigned' end as logical_destination_key_state"),
                    'auth_method',
                    'status',
                    'is_active',
                    'connected_at',
            ...
            'social_targets' => DB::table('social_post_targets')
                ...
                ->get([
                    ...
                    DB::raw("case when social_post_targets.logical_destination_key is null then 'missing' else 'assigned' end as logical_destination_key_state"),
