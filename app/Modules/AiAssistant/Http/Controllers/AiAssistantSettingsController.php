...
class AiAssistantSettingsController extends Controller
{
    ...
    private function payload(AiAssistantSetting $setting): array
    {
        return [
            ...
            'enable_proactive_suggestions' => (bool) $setting->enable_proactive_suggestions,
            'enable_upsell_suggestions' => (bool) $setting->enable_upsell_suggestions,
            'enable_client_history_recommendations' => (bool) $setting->enable_client_history_recommendations,
            'max_suggestions_per_response' => (int) ($setting->max_suggestions_per_response ?: 3),
            'require_confirmation_before_ai_action' => (bool) $setting->require_confirmation_before_ai_action,
            'allow_ai_to_choose_earliest_slot' => (bool) $setting->allow_ai_to_choose_earliest_slot,
            'allow_ai_to_recommend_staff' => (bool) $setting->allow_ai_to_recommend_staff,
            'allow_ai_to_recommend_services' => (bool) $setting->allow_ai_to_recommend_services,
